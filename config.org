...
(use-package jenkins
  :ensure t
  :config
    (setq jenkins-api-token "11fc5532c9ee7739e8c1cd86cba336e3cc"
          jenkins-url "https://avrdevjenkins00n.ndmad2.tripadvisor.com/job/nsp"
          jenkins-username "kward"
          jenkins-viewname nil))
#+END_SRC
